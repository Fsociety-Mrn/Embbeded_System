...
root.iconbitmap('hydroponic.ico')
root.state('zoomed')
root.resizable(0,0)
...
my_img_1 = (Image.open("water-level.png"))
...
my_img_3 = (Image.open("water-pump.png"))
...
my_img_4 = (Image.open("oxygen.png"))
